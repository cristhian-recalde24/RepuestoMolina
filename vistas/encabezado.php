...
<html>
  ...
  <body class="sidebar-mini fixed">
    <div class="wrapper">
      <!-- Navbar-->
      <header class="main-header hidden-print"><a class="logo" href="index.html">Molina</a>
            ...
            <ul class="top-nav">
              ...
              <li class="dropdown notification-menu"><a class="dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-bell-o fa-lg"></i></a>
                <ul class="dropdown-menu">
                  <li class="not-head">No tienes notificaciones.</li>
              ...
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user fa-lg"></i></a>
                <ul class="dropdown-menu settings-menu">
                  <li><a href="page-user.html"><i class="fa fa-cog fa-lg"></i> Configuracion</a></li>
                  <li><a href="page-user.html"><i class="fa fa-user fa-lg"></i> Perfil</a></li>
                  <li><a href="page-login.html"><i class="fa fa-sign-out fa-lg"></i> Salir</a></li>
                </ul>
              </li>
            </ul>
          </div>
      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li class="active"><a href="index.html"><i class="fa fa-dashboard"></i><span>Repuestos Molina</span></a></li>
            <li class="treeview"><a href="#"><i class="fa fa-laptop"></i><span>Personal</span><i class="fa fa-angle-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="bootstrap-components.html"><i class="fa fa-circle-o"></i> Clientes</a></li>
                <li><a href="ui-font-awesome.html"><i class="fa fa-circle-o"></i> Proveedores</a></li>
              </ul>
            </li>
            <li><a href="charts.html"><i class="fa fa-pie-chart"></i><span>Detalle ventas</span></a></li>
            <li class="treeview"><a href="#"><i class="fa fa-edit"></i><span>Detalle ventas</span><i class="fa fa-angle-right"></i></a>
              <ul class="treeview-menu">
            ...
            <li class="treeview"><a href="#"><i class="fa fa-th-list"></i><span>Articulos</span><i class="fa fa-angle-right"></i></a>
              <ul class="treeview-menu">
